...
public class AttendanceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                mPullToRefreshView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        SnackbarManager.show(
                                Snackbar.with(AttendanceList.this)
        ...
        boolean dirExist = storage.isDirectoryExists("Attendance/Attendance_Record");
        if(!dirExist) {
            storage.createDirectory("Attendance/Attendance_Record");
        }
        List<String> fileName = new ArrayList<>();
        try {
            files = storage.getFiles("Attendance/Attendance_Record", OrderType.DATE);
            int i = 0;
            for (File file : files) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String studentData = storage.readTextFile("Attendance/Attendance_Record", myFile);
    ...
    private void createData() {
        Intent intent = new Intent(AttendanceList.this, CreateData.class);
        startActivity(intent);
        finish();
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(AttendanceList.this, LoginActivity.class);
        startActivity(intent);
        finish();
    }
}
